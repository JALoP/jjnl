...
public class DigestAlgorithms
{
	...
	private static DigestAlgorithms instance;

	private boolean isSHA384Supported;
	private ArrayList<DigestAlgorithmEnum> supportedDigestAlgorithms;
	// this is the agreed upon algorithm after it's been negotiated 
	// with the publisher
	private DigestAlgorithmEnum selectedDigestAlgorithm;
	...
	public static synchronized DigestAlgorithms getInstance() {
		if(instance == null) {
			instance = new DigestAlgorithms();
		}
		return instance;
	}
	...
	public DigestAlgorithmEnum getSelectedDigestAlgorithm() {
		return this.selectedDigestAlgorithm;
	}

	public void setSelectedDigestAlgorithm(String uri) {
		DigestAlgorithmEnum alg = DigestAlgorithmEnum.fromUri(uri);
		this.selectedDigestAlgorithm = alg;
	}
	...
	public void clear()
	{
		this.supportedDigestAlgorithms.clear();
	}
